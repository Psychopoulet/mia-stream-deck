...
class OrchestratorStreamDeck extends node_pluginsmanager_plugin_1.Orchestrator {
    constructor(data) {
        super(Object.assign(Object.assign({}, data), { "packageFile": (0, node_path_1.join)(__dirname, "..", "..", "package.json"), "descriptorFile": (0, node_path_1.join)(__dirname, "..", "data", "Descriptor.json"), "mediatorFile": (0, node_path_1.join)(__dirname, "Mediator.js"), "serverFile": (0, node_path_1.join)(__dirname, "Server.js") }));
    }
    _initWorkSpace() {

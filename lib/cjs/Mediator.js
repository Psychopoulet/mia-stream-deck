...
class MediatorStreamDeck extends node_pluginsmanager_plugin_1.Mediator {
    ...
    _initWorkSpace(container) {
        this._file = (0, node_path_1.join)(this._externalResourcesDirectory, "tables.json");
    ...
    getFrontApp() {
        return (0, promises_1.readFile)((0, node_path_1.join)(__dirname, "..", "..", "public", "dist", "bundle.min.js"), "utf-8");
    }
    getFrontAppMap() {
        return (0, promises_1.readFile)((0, node_path_1.join)(__dirname, "..", "..", "public", "dist", "bundle.min.js.map"), "utf-8");
    }
    // api
    getTables() {
